...
public class PathUnifyKey {
    protected Long streamId;
    protected Integer domainId;
    protected String ingressNode;
    protected String egressNode;

    public PathUnifyKey(Long streamId, Integer domainId, String ingressNode, String egressNode) {
    ...
    public PathUnifyKey(PathUnifyKey source) {
    ...
    public boolean equals(Object obj) {
        ...
        PathUnifyKey other = (PathUnifyKey) obj;
        if (ingressNode == null) {
