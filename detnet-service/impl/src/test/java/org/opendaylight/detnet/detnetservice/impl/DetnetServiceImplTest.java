...
public class DetnetServiceImplTest extends AbstractConcurrentDataBrokerTest {
    ...
    public void checkCreateDetnetServiceInputTest() throws InterruptedException, ExecutionException {
        ListenableFuture<RpcResult<CreateDetnetServiceOutput>> result =
                detnetServiceImpl.createDetnetService(null);
        ...
        CreateDetnetServiceInput input = new CreateDetnetServiceInputBuilder()
                ...
                .setRelayNode(new ArrayList<RelayNode>())
                .build();
    ...
    public void createDetnetServiceTest1() throws InterruptedException, ExecutionException {
        ...
        CreateDetnetServiceInput input = new CreateDetnetServiceInputBuilder()
                ...
                .setRelayNode(new ArrayList<RelayNode>())
                .build();
        ListenableFuture<RpcResult<CreateDetnetServiceOutput>> result = detnetServiceImpl.createDetnetService(input);
        assertTrue(result.get().isSuccessful());
        ...
        for (Nodes node : deviceService.getNodes()) {
            if (node.getNodeId().equals("11.11.11.11")) {
                assertTrue(node.getDomainService().get(0).key().equals(new DomainServiceKey(1,111L)));
    ...
    public void createDetnetServiceTest2() throws InterruptedException, ExecutionException {
        when(driverApiService.writeDetnetServiceConfiguration(any())).thenReturn(RpcReturnUtil.returnSucess(null));
        ListenableFuture<RpcResult<CreateDetnetServiceOutput>> result = createDetnetServiceWithRelayNodes();
        assertTrue(result.get().isSuccessful());
        Services services = DetnetServiceDb.getInstance().getServicesFromServiceManagerDB(1,111L);
        assertEquals(2,services.getServiceProxyInstances().size());
    ...
    public void createDetnetServiceTest3() throws InterruptedException, ExecutionException {
        ...
        ListenableFuture<RpcResult<CreateDetnetServiceOutput>> result = createDetnetServiceWithRelayNodes1();
        assertTrue(result.get().isSuccessful());
        Services services = DetnetServiceDb.getInstance().getServicesFromServiceManagerDB(1,111L);
    ...
    public void deleteDetnetServiceTest() throws InterruptedException, ExecutionException {
        ...
        DeleteDetnetServiceInput deleteInput = new DeleteDetnetServiceInputBuilder()
                ...
                .setStreamId(111L)
                .build();
        ListenableFuture<RpcResult<DeleteDetnetServiceOutput>> result1 =
        ...
        ListenableFuture<RpcResult<DeleteDetnetServiceOutput>> result3 =
                detnetServiceImpl.deleteDetnetService(deleteInput);
        assertTrue(result3.get().isSuccessful());
    }
    ...
    public void deleteDetnetServiceTest1() throws InterruptedException, ExecutionException {
        ...
        ListenableFuture<RpcResult<DeleteDetnetServiceOutput>> result1 =
                detnetServiceImpl.deleteDetnetService(deleteInput);
        assertTrue(!result1.get().isSuccessful());
        assertTrue(result1.get().getErrors().iterator().next().getMessage().contains("ERROR!"));
    }

    private ListenableFuture<RpcResult<CreateDetnetServiceOutput>> createDetnetServiceWithRelayNodes()
    ...
    private ListenableFuture<RpcResult<CreateDetnetServiceOutput>> createDetnetServiceWithRelayNodes1()
            throws ExecutionException,
            InterruptedException {
        CreateDetnetServiceInput input = new CreateDetnetServiceInputBuilder()
                .setDomainId(1)
